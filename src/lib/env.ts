...
const envSchema = z.object({
  ...
  OKX_DEX_API_BASE_URL: z.string().url().default("https://web3.okx.com"),
  OKX_DEX_CHAIN_INDEX: z.string().default("196"),
  OKX_DEX_PROJECT_ID: z.string().optional().default(""),
  OKX_DEX_QUOTE_TOKEN_ADDRESS: z.string().startsWith("0x").default("0x779ded0c9e1022225f8e0630b35a9b54be713736"),
  OKX_DEX_TOKENS_PATH: z.string().default("/api/v6/dex/aggregator/all-tokens"),
  OKX_DEX_QUOTE_PATH: z.string().default("/api/v6/dex/aggregator/quote"),
  OKX_DEX_SWAP_PATH: z.string().default("/api/v6/dex/aggregator/swap"),
  OKX_DEX_CHAIN_DATA_PATH: z.string().default("/api/v6/dex/aggregator/get-chain-data"),
  OKX_DEX_TIMEOUT_MS: z.coerce.number().int().positive().default(15000),
  ...
  NEXT_PUBLIC_OKX_PROJECT_ID: z.string().optional().default(""),
...
export const env = envSchema.parse({
  ...
  OKX_DEX_API_BASE_URL: process.env.OKX_DEX_API_BASE_URL,
  OKX_DEX_CHAIN_INDEX: process.env.OKX_DEX_CHAIN_INDEX,
  OKX_DEX_PROJECT_ID: process.env.OKX_DEX_PROJECT_ID,
  OKX_DEX_QUOTE_TOKEN_ADDRESS: process.env.OKX_DEX_QUOTE_TOKEN_ADDRESS,
  OKX_DEX_TOKENS_PATH: process.env.OKX_DEX_TOKENS_PATH,
  OKX_DEX_QUOTE_PATH: process.env.OKX_DEX_QUOTE_PATH,
  OKX_DEX_SWAP_PATH: process.env.OKX_DEX_SWAP_PATH,
  OKX_DEX_CHAIN_DATA_PATH: process.env.OKX_DEX_CHAIN_DATA_PATH,
  OKX_DEX_TIMEOUT_MS: process.env.OKX_DEX_TIMEOUT_MS,
