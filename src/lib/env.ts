...
const envSchema = z.object({
  ...
  OKX_PAYMENT_VERIFY_URL: z.string().url().optional().or(z.literal("")).default(""),
  OKX_PAYMENT_API_KEY: z.string().optional().default(""),
  X402_NETWORK: z.string().default("xlayer"),
  X402_ASSET: z.string().default("OKB"),
...
export const env = envSchema.parse({
  ...
  OKX_PAYMENT_VERIFY_URL: process.env.OKX_PAYMENT_VERIFY_URL,
  OKX_PAYMENT_API_KEY: process.env.OKX_PAYMENT_API_KEY,
